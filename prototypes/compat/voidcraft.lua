if mods["Voidcraft"] then
  ...
  table.insert(vc_recipes, VOIDCRAFT.voidcraft_recipe(
    {
      prefix = "__astroponics__",
      subgroup = "voidcraft-orbital",
      fluid = 60,
      secondary_item = true
    },
    { "liquid-fertilizer", "tree-seed", "sulfur" },
    "vga-ga",
    vcc.petrochem_liquid,
    "s6x-void-orbital",
    { 0.4, 0.8, 0.133 }
  ))
